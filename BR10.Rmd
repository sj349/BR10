...
d. I think our choice to use a Normal model is reasonable. Despite the small "bumps" along the left side, the observed data is normally shaped. I think the deviance between our predictions and the observed distribution might result from the weakly informative priors we used in our posterior model.
...
This is confirmed in our statistical check--the within_50 percentage is very low (45%). Based on the model's deviance from the observed distribution, and our summary statistics, I would say that for this bimodal distribution, perhaps a normal model isn't the best fit. 
